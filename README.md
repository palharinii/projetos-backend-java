...
[![Roadmap](https://img.shields.io/badge/Roadmap-Java-blue?logo=roadmapdotsh&logoColor=white)](https://roadmap.sh/java)

> Este repositório foi dedicado exclusivamente para registrar o meu aprendizado com desenvolvimento backend em Java, utilizando como referência este site aqui: [roadmap.sh](https://roadmap.sh/java).
